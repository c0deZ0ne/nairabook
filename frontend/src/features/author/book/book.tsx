...
function Book() {
  ...
  return (
    <div className='flex flex-col w-[100%] h-[100%]'>
        ...
        <Breadcrumb title='Books' Element={<Button handleClick={(e: any)=>handleEdit({event:e})} value={"Add Book"} className='text-[12px] text-white h-[30px] bg-blue-600 w-[100px] mt-auto mb-auto' />} showBack={false}/>
        </div>
